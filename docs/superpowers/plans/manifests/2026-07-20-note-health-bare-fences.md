# note-health 裸代码围栏修复清单

> 初始基线：1824 处 opening fence，500 个文件。只读枚举；实施时逐文件判断语言。

## 01.java / build-tools（1 文件，3 处）

- `note/01.java/build-tools/README.md` — lines: 219, 330, 335

## 01.java / collection（9 文件，102 处）
...
## 01.java / concurrency（18 文件，144 处）
...
## 02.computer-basics / 01-network（8 文件，42 处）
...
## 02.computer-basics / 02-algorithms（10 文件，25 处）
...
## 02.computer-basics / 06-operating-system（5 文件，34 处）
...
## 04.system-design / 02-distributed（7 文件，24 处）
...
## 04.system-design / 03-high-availability（3 文件，16 处）
...
## 04.system-design / 04-high-performance（18 文件，101 处）
...
## 04.system-design / 05-security（22 文件，60 处）
...
## 04.system-design / 06-idempotency（6 文件，12 处）
...
## 04.system-design / 07-deployment（3 文件，38 处）
...
## 04.system-design / 08-observability（5 文件，18 处）
...
## 04.system-design / 09-emerging-tech（4 文件，14 处）
...
## 06.spring / 04-spring-boot（4 文件，6 处）
...
## 06.spring / 05-spring-cloud（3 文件，8 处）
...
## 06.spring / 06-integration（2 文件，2 处）
...
## 06.spring / 07-observability（4 文件，9 处）
...
## 06.spring / 08-annotations（3 文件，4 处）
...
## 06.spring / 09-security（6 文件，26 处）
...
## 08.application-systems / 03-supply-chain（3 文件，3 处）
...
## 11.ai / 02-technology-stack（24 文件，73 处）
...
## 11.ai / 03-engineering（35 文件，100 处）
...
## 11.ai / 04-architecture（20 文件，60 处）
...
## 11.ai / 05-applications（3 文件，7 处）
...
## 13.split-hairs / 02.computer-basics（5 文件，26 处）
...
## 13.split-hairs / 03.database（20 文件，69 处）
...
## 13.split-hairs / 04.system-design（17 文件，52 处）
...
## 13.split-hairs / 05.security（10 文件，29 处）
...
## 13.split-hairs / 06.spring（7 文件，11 处）
...
## 13.split-hairs / 09.front-end（14 文件，40 处）
...
## 13.split-hairs / 11.ai（28 文件，109 处）
