...
> ⬅️ [返回目录](README.md) | 上一篇：[智医同源](README2.md)
...
- ✅ **标准化认证与发现**：内置 OAuth、OAuth 2.0 Dynamic Client Registration (RFC 7591) 等机制，降低集成复杂度
...
**推荐方案：OAuth 2.0 Dynamic Client Registration (RFC 7591) + Vault 托管**
