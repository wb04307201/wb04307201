...
第 14 课：AI 时代的认知债务与深度工作 是 3 个章节的合集。
...
- 前置课程：[第 13 课：基于 Spec 的 AI 驱动开发](README.md)
- 知识准备：具备 AI 辅助开发的实际使用经验，对 Prompt 工程有基本认知
- 推荐阅读：[第 2 课：Agent Harness 与控制论](README.md)（理解 Harness 工程中人类角色的定位）
...
⬅️ 上一课：[基于 Spec 的 AI 驱动开发](README.md) | ➡️ 下一课：[AI 原生组织](README.md)
