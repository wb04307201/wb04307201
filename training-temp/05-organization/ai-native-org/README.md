...
- 前置课程：[第 14 课：AI 时代的认知债务与深度工作](README.md)
- 知识准备：理解 AI Agent 的核心架构和多智能体协同模式
- 推荐阅读：[第 6 课：多智能体协同](README.md)、[第 8 课：Agent 设计模式与架构](README.md)
...
⬅️ 上一课：[AI 时代的认知债务与深度工作](README.md) | ➡️ 下一课：[LLM 驱动的个人知识库](README.md)
