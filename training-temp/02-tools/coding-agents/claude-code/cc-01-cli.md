...
[更多信息请看：规范驱动开发工具深度解析：Spec-Kit、Kiro、OpenSpec](../../agent-spec-tools/sh-02-sdd.md)
[更多信息请看：Spec-Kit 规范驱动开发（SDD）工具包使用说明](../../agent-spec-tools/sh-03-speckit.md)
...
[更多信息请看：MCP（Model Context Protocol）推荐](../../mcp/sh-01-mcp.md)
...
## 其它
- [Spec-Kit 规范驱动开发（SDD）工具包使用说明](../../agent-spec-tools/sh-03-speckit.md)
