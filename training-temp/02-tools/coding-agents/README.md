...
| 章节 | 文件 | 核心问题 | 建议时长 |
|:----:|:-----|:---------|:--------:|
| A-01 | [Claude Code CLI 配置指南](claude-code/cc-01-cli.md) | 如何搭建 Claude Code 开发环境？ | 30 min |
| A-02 | [Claude Code 插件系统](claude-code/cc-02-plugins.md) | 插件如何提升效率？ | 30 min |
| A-03 | [Claude Code Skills 深度解析](claude-code/cc-03-skills.md) | Skills 如何组织和使用？ | 30 min |

### Part B：Codex

| 章节 | 文件 | 核心问题 | 建议时长 |
|:----:|:-----|:---------|:--------:|
| B-01 | [Codex CLI 配置指南](codex/cx-01-cli.md) | OpenAI Codex 如何配置百炼？ | 20 min |
| B-02 | [Codex Superpowers 安装与使用](../agent-spec-tools/cx-02-superpowers.md) | 🆕 Codex 如何安装和使用 Superpowers？ | 30 min |

### Part C：OpenCode

| 章节 | 文件 | 核心问题 | 建议时长 |
|:----:|:-----|:---------|:--------:|
| C-01 | [OpenCode CLI 配置指南](opencode/oc-01-cli.md) | OpenCode 如何配置百炼？ | 20 min |

### Part D：通用主题

| 章节 | 文件 | 核心问题 | 建议时长 |
|:----:|:-----|:---------|:--------:|
| D-01 | [MCP 推荐](../mcp/sh-01-mcp.md) | 哪些 MCP 服务器值得用？ | 30 min |
| D-02 | [规范驱动开发工具对比](../agent-spec-tools/sh-02-sdd.md) | 三大 SDD 工具如何选型？ | 40 min |
| D-03 | [Spec-Kit 使用说明](../agent-spec-tools/sh-03-speckit.md) | Spec-Kit 工作流如何落地？ | 40 min |
...
#### [claude-code/cc-01-cli.md](claude-code/cc-01-cli.md) - Claude Code CLI 配置指南
- **核心内容**：Claude Code 安装与阿里云百炼平台模型 API 配置
- **关键知识点**：Node.js 安装、百炼模型配置（千问全系列）、MCP 工具集成、Windows 环境依赖、插件与 Skills 入口

#### [claude-code/cc-02-plugins.md](claude-code/cc-02-plugins.md) - Claude Code 插件系统
- **核心内容**：官方与社区插件生态详解
...
#### [claude-code/cc-03-skills.md](claude-code/cc-03-skills.md) - Claude Code Skills 深度解析
...
⬅️ [上一课：多智能体协同](README.md) | ➡️ [下一课：AI Agent 设计模式与架构](README.md)
