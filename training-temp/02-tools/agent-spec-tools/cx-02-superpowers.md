...
← [Codex CLI 配置](../coding-agents/codex/cx-01-cli.md) · [Claude Code 插件系统](../coding-agents/claude-code/cc-02-plugins.md) · [MCP 推荐](../mcp/sh-01-mcp.md)
...
- 前置：[Codex CLI 配置指南](../coding-agents/codex/cx-01-cli.md) — Codex 安装与百炼模型配置
- 通用 MCP：[MCP 推荐](../mcp/sh-01-mcp.md) — 可配合的 MCP 服务器
- Claude Code 版：[Claude Code 插件系统](../coding-agents/claude-code/cc-02-plugins.md) — Claude Code 的 Superpowers
- Claude Code Skills：[Skills 深度解析](../coding-agents/claude-code/cc-03-skills.md) — Skills 架构详解
