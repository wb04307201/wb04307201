...
module:
  ...
  slug: application-systems/03-supply-chain/wms
  type: article
  category: 主模块子文章
...
- **所属价值链**：03 供应链
- 关联系统：ERP（[ERP 深读](../../05-operations/erp/README.md)）/ MES（[MES 深读](../../02-production/mes/README.md)）/ TMS（[TMS 深读](../tms/README.md)）/ SCM（[SCM 深读](../scm/README.md)）/ SRM（[SRM 深读](../srm/README.md)）/ AGV/AMR（[02 生产制造](../../02-production/README.md)）
