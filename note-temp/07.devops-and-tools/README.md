...
- 下游：[`04.spring-backend`](../../note/06.spring/README.md) — Spring 全家桶（工具链的核心应用场景）
- 横向：[`03.data-stack`](../../note/03.database/README.md) — 数据库（部署 / 备份 / 监控）
- 横向：[`06.distributed-systems`](../../note/04.system-design/README.md) — 分布式系统（K8s/Nginx/Monorepo 架构决策）
- 横向：[`08.ai-foundations`](../../note/11.ai/README.md) — AI 工程（bpmn-ai-integration）
- 业务：[`10.business-systems`](../../note/08.application-systems/README.md) — 业务系统（流程引擎在 ERP/MES/CRM 中的应用）
