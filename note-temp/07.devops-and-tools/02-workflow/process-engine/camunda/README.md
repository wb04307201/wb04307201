...
**Camunda 引擎 = BPMN 2.0 标准的两大主流实现**——Camunda 7（嵌入式 PVM 单体）+ Camunda 8/Zeebe（云原生分布式），前者强在治理与生态，后者强在扩展与 AI。
...
| 维度 | 数据 |
|------|------|
| **覆盖版本** | 2（Camunda 7 / Camunda 8 + Zeebe） |
| **对比维度** | 7（架构 / 存储 / 扩展 / 吞吐 / AI / 部署 / 适用） |
| **子目录** | 3（camunda-7 / camunda-8 / zeebe） |
| **Mermaid 图** | 1（版本树） |
