...
> 📌 完整架构 + 4 融合模式见 [BPMN+AI 融合](../../../../../../note/11.ai/04-architecture/bpmn-ai-integration.md)。
...
**对比 AI 平台**（与 [11.ai 编排平台](../../../../../../note/11.ai/03-engineering/ai-platforms/README.md) 互补）：
...
- **C 端快速试错** → Dify / Coze
- **复杂多步推理** → LangGraph
- **混合** → Camunda 8 流程骨架 + LangGraph 复杂 Agent（详见 [BPMN+AI 融合](../../../../../../note/11.ai/04-architecture/bpmn-ai-integration.md)）
