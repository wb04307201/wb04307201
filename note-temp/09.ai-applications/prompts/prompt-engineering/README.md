...
📌 **驾驭演进主线**：[LLM 驾驭演进史（Prompt → Context → Harness → Loop）](../../../../note/11.ai/04-architecture/llm-control-evolution/README.md)
...
**应用**：Function Calling、AI Agent（详见 [function-calling](../../../../note/11.ai/02-technology-stack/function-calling/README.md)）。
...
> 完整陷阱 + 反直觉 + 30 秒话术见 [13.split-hairs Prompt Engineering](../../../../note/13.split-hairs/11.ai/prompt-engineering/README.md)
...
- 演进下一步：[Context Engineering](../../../../note/11.ai/02-technology-stack/context-engineering/README.md) — 范式二：给 LLM 提供完整上下文
- 关联：[RAG](../../rag/03-rag-vs-finetuning.md) — Prompt 工程在 RAG 中的应用
- 面试深挖：[13.split-hairs Prompt Engineering](../../../../note/13.split-hairs/11.ai/prompt-engineering/README.md) — 陷阱 + 反直觉 + 30 秒话术
- 故事版：[12.story #42 Prompt 工程](../../../../note/12.story/40-prompt-engineering.md) — 阿明餐厅叙事版
