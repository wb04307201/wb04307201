...
- 对：详见 ⚠️ 12.story/39-ai-private-deployment 的"先 RAG 再微调"（占位 `[../../../../13.story/39-ai-private-deployment.md](../../../../13.story/39-ai-private-deployment.md)`，待 Phase 1+ 迁入）
