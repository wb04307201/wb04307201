...
- **相关章节**：
  ...
  - [Function Calling](../../../../../note/11.ai/02-technology-stack/function-calling/README.md) — 工具调用原理（Acting 阶段基础）
  - [LLM 监控](../../../../../note/11.ai/08-llmops/production-stability/05-online-monitoring.md) — 4 维监控体系
