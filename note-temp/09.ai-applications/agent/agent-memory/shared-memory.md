...
> 一句话定位：**单 Agent Memory 解决"跨调用"；多 Agent 共享记忆解决"跨进程"，本质是分布式系统问题**。完整体系基于 [主模块 · Agent Memory 架构](README.md)。面试速查版见 [13.split-hairs · multi-agent-shared-memory](../../../../note/13.split-hairs/11.ai/multi-agent-shared-memory/README.md)。
...
- [兄弟题 · agent-memory-classification](../../../../note/13.split-hairs/11.ai/agent-memory-classification/README.md) — 单 Agent Memory 三维分类
- [兄弟题 · multi-agent-system-design](../../../../note/13.split-hairs/11.ai/multi-agent-system-design/README.md) — 5 大组件 + 死循环防护
