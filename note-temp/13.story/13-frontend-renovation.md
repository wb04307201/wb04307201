...
- [09.front-end / 04 工程化](../../note/09.front-end/04-engineering/README.md) —— Vite / pnpm / Monorepo / 测试体系：前端工程化工具链选型
- [09.front-end / 06 性能](../../note/09.front-end/06-performance/README.md) —— Core Web Vitals（LCP/INP/CLS）与性能监控体系
- [09.front-end / 05 架构](../../note/09.front-end/05-architecture/README.md) —— 渲染模式 / 状态管理 / 微前端 / BFF
