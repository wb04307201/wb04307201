...
> 🔗 面试深挖版：[`Error vs Exception 面试题`](../../../../note/13.split-hairs/01.java/error-vs-exception/README.md) — 6 维度对比 + 5 反模式 + 面试话术
...
5. **不要用异常做流程控制**：异常处理有性能开销，应该用于真正的异常情况。详见面试题：[try-catch 性能影响](../../../../note/13.split-hairs/01.java/try-catch-performance/README.md) — 正常路径零开销 / fillInStackTrace 根因 / OmitStackTraceInFastThrow 优化
