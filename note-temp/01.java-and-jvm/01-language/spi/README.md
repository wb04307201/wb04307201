...
- [Spring SPI 对比（06.spring 专题）](../../../../note/06.spring/04-spring-boot/spring-factories-migration.md) — Spring Framework 的 SpringFactoriesLoader 与 JDK ServiceLoader 异同
