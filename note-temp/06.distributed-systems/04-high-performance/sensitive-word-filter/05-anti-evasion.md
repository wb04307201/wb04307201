...
**L3 的定位**：不是替代词典，而是**对 L1/L2 漏网的、疑似但不确定的内容做异步二审**。详见 [11.ai/08-llmops/05-llm-security](../../../../note/11.ai/08-llmops/05-llm-security/README.md) 的内容审核部分。
...
- AI 兜底：[11.ai/08-llmops/05-llm-security](../../../../note/11.ai/08-llmops/05-llm-security/README.md) —— LLM 内容审核（L3 语义兜底）
