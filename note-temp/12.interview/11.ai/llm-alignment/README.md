...
> ⬅️ [返回 AI 咬文嚼字](../README.md) | [主模块深度专题](../../../../note/11.ai/07-research/alignment/README.md)
...
- **主模块深度**：[llm-alignment](../../../../note/11.ai/07-research/alignment/README.md) — 5 大方法完整版
- **兄弟面试题**：[Agent 性能评估](../agent-performance-evaluation/README.md) 顺带提
- **餐厅叙事**：[12.story 系列目录](../../../../note/12.story/README.md)（对齐主题餐厅叙事篇待补）
