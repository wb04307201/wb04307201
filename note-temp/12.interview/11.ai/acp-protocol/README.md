...
> 一句话定位：ACP（Zed 出品 Apache 2.0）是**编辑器 ↔ Coding Agent** 的标准化通信协议，类似 LSP 对语言服务器的角色。深度原理见 [协议层深度](../../../../note/11.ai/02-technology-stack/context-engineering/acp-protocol/README.md) + [概念地图 ACP 条目](../../../../note/11.ai/02-technology-stack/concept-map/README.md#四-核心组件)。
...
- **协议层深度**：[`acp-protocol.md`](../../../../note/11.ai/02-technology-stack/context-engineering/acp-protocol/README.md) — ACP 架构 + JSON-RPC 2.0 扩展 + Python SDK 示例 + 与 MCP/A2A/ANP 完整对比
- **概念地图**：[`concept-map.md`](../../../../note/11.ai/02-technology-stack/concept-map/README.md) — ACP 在 Agent 协议族中的位置
- **MCP 对比**：[`mcp`](../../../../note/11.ai/02-technology-stack/context-engineering/README.md#mcp-model-context-protocol) — Agent ↔ 工具协议（在 context-engineering README 中描述）
