...
> 一句话定位：Function Calling 是让 LLM 输出结构化 JSON 来声明要调用的工具（而非直接执行），是 AI Agent 的核心机制。完整概念见 [主模块 Function Calling](../../../../note/11.ai/02-technology-stack/function-calling/README.md)。
...
- 主模块：[Function Calling](../../../../note/11.ai/02-technology-stack/function-calling/README.md)
