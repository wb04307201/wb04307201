...
> AI 编程工具的成本真相 —— 考察的不是"AI 贵不贵"，而是 **杠杆率思维** + **Token 悖论** + **Agent 工作流消耗机制** + **企业级成本失控案例**。完整 Token 基础见 [Token 与计费](../../../../note/11.ai/02-technology-stack/token-billing/README.md)。
...
- 主模块：[`Token 与计费原理`](../../../../note/11.ai/02-technology-stack/token-billing/README.md) — 分词算法 + 上下文窗口 + 计费公式
