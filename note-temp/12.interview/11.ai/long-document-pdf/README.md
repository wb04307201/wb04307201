...
> ⬅️ [返回 AI 咬文嚼字](../README.md) | [主模块深度专题](../../../../note/11.ai/02-technology-stack/long-document-processing/README.md)
...
- **主模块深度**：[长文档处理（几百页 PDF 合同）](../../../../note/11.ai/02-technology-stack/long-document-processing/README.md) — 4 大策略整合 + 实战选型决策树
