...
> 📚 **前置知识**：[Spring MVC 请求流程](../../../../note/06.spring/02-web/mvc/README.md) | [AOP 原理](../aop-principle/README.md)
...
- 同栏目：[`Spring MVC 请求流程`](../../../../note/06.spring/02-web/mvc/README.md) — 请求从 DispatcherServlet 到 Controller 的完整链路
- 主模块：[`安全架构`](../../../../note/04.system-design/05-security/README.md) — 认证授权原理
