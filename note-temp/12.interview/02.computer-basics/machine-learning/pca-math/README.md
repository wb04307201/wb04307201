...
- **主模块**：[`02-algorithms/dimensionality-reduction/pca`](../../../../../note/02.computer-basics/02-algorithms/dimensionality-reduction/pca/README.md) — PCA 完整原理 + 实战代码
- **11.ai 关联**：[`embedding-vs-vectorization`](../../../../../note/11.ai/01-fundamentals/embedding-vs-vectorization/README.md) — BERT/LLM Embedding 高维（768-4096 维），实战中常用 PCA→128 维再入库做 ANN 检索
