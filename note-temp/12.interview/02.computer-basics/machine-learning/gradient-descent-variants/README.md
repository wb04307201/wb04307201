...
- **主模块**：[`02-algorithms/optimization/gradient-descent`](../../../../../note/02.computer-basics/02-algorithms/optimization/gradient-descent/README.md) — 梯度下降的几何直觉与收敛条件
- **兄弟**：[`k-means-convergence`](../k-means-convergence/README.md) / [`peft-lora`](../../../../../note/13.split-hairs/11.ai/peft-lora/README.md) — AdamW 在 LLM 参数高效微调中的应用 / [`llm-alignment`](../../../../../note/13.split-hairs/11.ai/llm-alignment/README.md)
