...
- **相关主题**：[Redis发布订阅](../../../../note/03.database/07-redis/README.md)
- **延伸学习**：[Spring Web](../../../../note/06.spring/02-web/README.md)
- **分布式架构**：[消息队列对比](../../../../note/04.system-design/04-high-performance/mq/README.md)
