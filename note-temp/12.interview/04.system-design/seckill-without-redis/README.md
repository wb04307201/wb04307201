...
> 一句话定位：**大厂面试经典刁难题**。考察架构师的**应变能力** —— 当主流方案（Redis 分布式锁 / MQ 削峰）被禁用时，怎么用**最朴素的单机工具**解决问题。深度实战见 [主模块深度章节](../../../06.distributed-systems/03-high-availability/rate-limiting/seckill-without-redis.md)。
...
**主模块**：
- [秒杀刁难题深度章节](../../../06.distributed-systems/03-high-availability/rate-limiting/seckill-without-redis.md) — 5 方案对比 + 3 大机制 + 2 台服务器一致性 + 实战模板
- [限流原理（rate-limiting/README）](../../../06.distributed-systems/03-high-availability/rate-limiting/README.md) — 4 算法 + 4 策略
- [乐观锁（optimistic-lock）](../../../06.distributed-systems/06-idempotency/optimistic-lock/README.md) — 库存扣减基础
