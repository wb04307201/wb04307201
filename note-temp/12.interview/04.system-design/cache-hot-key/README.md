...
> 📚 **前置知识**：[Redis 集群](../../../../note/03.database/07-redis/README.md) | [缓存穿透/击穿/雪崩](../../../../note/03.database/06-cache/README.md)
...
- 主模块：[`缓存穿透/击穿/雪崩`](../../../../note/03.database/06-cache/README.md) — 缓存三大问题与解决方案
- 主模块：[`Redis`](../../../../note/03.database/07-redis/README.md) — Redis 集群与分片原理
