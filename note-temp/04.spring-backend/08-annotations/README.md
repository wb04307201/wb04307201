...
- [13 辨析/为什么不推荐 @Autowired 字段注入](../../../note/13.split-hairs/06.spring/not-use-@autowired/README.md) — 字段注入 vs 构造器注入
- [13 辨析/PO-VO-DTO-BO-DAO-POJO 语义辨析](../../../note/13.split-hairs/06.spring/clarify-various-o/README.md) — 各层对象语义
