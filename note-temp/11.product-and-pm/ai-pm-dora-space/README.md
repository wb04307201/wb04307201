...
> **前置知识**：[12.story/43-ai-productivity-paradox](../../../note/12.story/43-ai-productivity-paradox.md)（Waydev/GitClear 数据真相）、[12.story/29-codebase-cognitive-debt](../../../note/12.story/29-codebase-cognitive-debt.md)（认知债）、[13.split-hairs/09.front-end/this-binding](../../../note/13.split-hairs/09.front-end/this-binding/README.md)等 AI 主题面试题。
...
### 真实案例（用 [12.story/45](../../../note/12.story/43-ai-productivity-paradox.md) 的数据）
...
- [ ] **架构债 / 认知债** —— 同时看 [12.story/29-codebase-cognitive-debt](../../../note/12.story/29-codebase-cognitive-debt.md)
- [ ] **组织能力评估** —— 用 SPACE 中"沟通 / 协作"维度，结合 [12.story/07-from-chef-to-ceo](../../../note/12.story/07-from-chef-to-ceo.md)
...
- 故事章节：[`12.story/43-ai-productivity-paradox`](../../../note/12.story/43-ai-productivity-paradox.md) — Waydev/GitClear/Faros/Jellyfish 数据
- 故事章节：[`12.story/29-codebase-cognitive-debt`](../../../note/12.story/29-codebase-cognitive-debt.md) — AI 时代认知债
- 故事章节：[`12.story/42-ai-engineer-responsibility`](../../../note/12.story/42-ai-engineer-responsibility.md) — AI 责任金字塔
- 故事章节：[`12.story/07-from-chef-to-ceo`](../../../note/12.story/07-from-chef-to-ceo.md) — 组织管理康威定律
