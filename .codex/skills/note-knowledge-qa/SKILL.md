...
| **E. 简历面试** | "根据简历出题"、"帮我准备面试他" | 解析简历 → 匹配 note → 出题 |
...
| `14.project-management` | 项目管理、DORA、研发效能 |
...
- 面试题类型：同时读 `13.split-hairs` 和主模块（双层检索）
...
> 
> **建议**：这个主题值得沉淀到 note/，可以运行 `the note-precipitation-planning skill` 规划位置。
