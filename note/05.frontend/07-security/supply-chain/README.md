...
- **2021 ua-parser-js**：流行库被攻击者劫持，植入挖矿与凭证窃取代码
- **2018 event-stream**：流行库被注入恶意代码，窃取加密货币钱包

---
## 引言：生产 Bug

依赖供应链安全 的关键不是'防住'——是**出事后 5 分钟内能定位**。
...
- [`04-engineering/monorepo/`](../../../../note/05.tools/05-monorepo/README.md/) — Monorepo 的依赖治理
- [`07-security/`](../) — 安全总览
