...
module:
  ...
  slug: system-design/web-security
  type: article
  category: 主模块子文章
...
> 一份按漏洞类型组织的 Web 攻防实战手册：逐类给出攻击原理与代码级防御。完整风险清单见 [OWASP Top 10](../owasp-top10/README.md)。

---
## 引言：生产 Bug

Web 安全：XSS / CSRF / SQLi 攻防实战 的关键不是'防住'——是**出事后 5 分钟内能定位**。

本篇用真实生产场景切入：线上怎么炸、按官方文档写为什么也会错、怎么止血。

---

## 一、本篇与 OWASP Top 10 的对应

本篇是**攻防实战**视角（按漏洞类型组织），与标准清单视角互补：

- 完整 10 大风险的权威索引 + 代码级逐项防御，见 [OWASP Top 10（2021）](../owasp-top10/README.md)
- 本篇聚焦高频 Web 攻击的**攻击链还原 + 实战止血**：注入 / XSS / CSRF / SSRF / XXE / 文件上传 / 暴力破解 / HTTP 安全头
