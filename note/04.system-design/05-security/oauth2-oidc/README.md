...
**替代方案**: 使用 **Authorization Code + PKCE**（见下方第 4 种模式）
...
### 4. Authorization Code + PKCE — 移动端/SPA 推荐
...
| 框架 | 说明 |
|------|------|
| Spring Security OAuth2 | Spring 生态标准 OAuth2/OIDC 实现 |
| Spring Authorization Server | Spring 官方授权服务器实现 |
