...
GraphQL 本应该很简单，近年来，GraphQL API 的设计风格已从早期探索走向成熟实践，**核心原则是平衡灵活性与约束性**，避免过度自由带来的性能、安全和维护风险
...
> 📌 **终极建议**：**不要设计”完全开放”的 GraphQL API**。将其视为一个**受控的查询引擎**，而非无限制的数据黑洞。近年来，成熟团队已将安全、性能、演进成本作为设计的第一优先级。
