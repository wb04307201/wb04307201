...
答案很简单：**系统能处理 200 单/分钟，不等于能处理瞬间 500 单**。流量治理的本质，不是让系统"无限扩容"，而是在资源有限的前提下，**让系统"优雅地应对过载"**。
...
| 熔断 | 快速失败 | 某道菜自动下架 | Hystrix / Sentinel |
...
阿明的午高峰保卫战，本质上是所有高并发系统都要面对的问题：**资源有限，流量无限，如何在两者之间找到平衡？**
