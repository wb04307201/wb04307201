...
graph LR
  ...
  class B,H1,H2,H3,H4,H5,H6,H7,H8,H9,H10,H11,H12,H13,H14,H15,H16,H17,H18 purple
```
...
>
> ⚠️ **2026 重要说明**：34/35/36 三篇已拆分为 34a/34b、35a/35b、36a/36b（结构性优化），旧重定向文件已移除。续集十三-十七（37-41）+ 番外七-八（42-43）为本期新增。
...
| 产品经理 | 番外一 → 番外二 → 番外五 → 续集三 → 前传 → 正传 9 → 番外四 | 重构决策 → 云成本 → 低代码 → AI 转型 → 架构全貌 → 故障复盘 → 搜索推荐 |
