...
| 阶段 | 阿明面对的问题 | 架构决策 |
|------|--------------|----------|
| 小本经营 | 30 碗面，一个人搞定 | 单机 MySQL，简单就是最好 |
| 开始排队 | 顾客等太久 | 引入缓存，读写分离 |
| 业务扩张 | 奶茶和面打架 | 垂直拆分，各管各的 |
| 订单爆炸 | 单表查询 10 秒 | 水平分片，按区域管理 |
| 单店风险 | 一停电动全城 | 集群部署，多地多活 |
| 智能运营 | 系统太聪明，人跟不上 | 云原生 + AI，让系统自治 |
...
- [一个厨房四个门面](./21-multiplatform-architecture.md) —— 架构演进到多端，统一网关和适配层成为新的架构挑战
