...
小周问："这也太麻烦了吧？AI 推荐的菜十道里有九道是好的，为了那一道不好的搞这么大阵仗？"
...
- [传菜窗口的智慧](./17-async-messaging.md) —— 审核工作流中的异步通知和升级机制，和消息队列的设计思路一致
...
- [菜谱标准化之路](./23-tech-docs-knowledge.md) —— 食材兼容性数据库和知识库的建设，是知识工程在安全领域的应用
