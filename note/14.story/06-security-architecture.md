...
- [当餐厅长出大脑](./01-ai-agent-architecture.md)第七章 —— AI Agent 的安全护栏：Prompt 注入防护、权限沙箱、输出校验
...
阿明的食安大检查，本质上是所有系统都要面对的合规和安全挑战：**在开放和便利的前提下，如何保护数据和系统的安全？**

答案是六大防线的纵深防御：身份认证确认身份，权限控制限制访问，数据加密保护数据，零信任缩小爆炸半径，审计日志追溯操作，数据脱敏隐藏敏感信息。
