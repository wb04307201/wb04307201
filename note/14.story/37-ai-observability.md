...
**AI Observability = 传统 3 大支柱（Logs / Metrics / Traces）+ AI 特有 3 大支柱（LLM 调用 / Token 成本 / 决策路径）+ 决策质量（Quality）= **7 大支柱 AI 时代可观测性体系**。
...
## 第四章：OpenTelemetry + LLM 扩展（标准化的未来）
...
## 第六章：与 14.story 其他篇章的协同

### 6.1 AI Observability 在 14.story 中的位置
