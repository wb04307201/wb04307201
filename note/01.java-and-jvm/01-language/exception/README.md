...
5. **不要用异常做流程控制**：异常处理有性能开销，应该用于真正的异常情况。详见面试题：[try-catch 性能影响](../../../12.interview/01.java/try-catch-performance/README.md) — 正常路径零开销 / fillInStackTrace 根因 / OmitStackTraceInFastThrow 优化
...
<!-- TODO: 拆分候选 (603 行 / 17 个 H2，超 500+8 阈值） -->
