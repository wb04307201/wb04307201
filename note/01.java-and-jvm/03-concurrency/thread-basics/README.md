...
> **一句话定位**：Java 线程基础涵盖 Thread 继承、Runnable、Callable 与线程池，掌握线程生命周期与状态切换。
...
**面试配套**：[12.interview/01.java/thread-sequential-execution](../../../12.interview/01.java/thread-sequential-execution/README.md) — 5 题面试题版（语义陷阱 / join 原理 / CountDownLatch 选型 / CompletableFuture 链式 / 生产推荐）
