...
> 一句话定位：LLM 不是万能解——能用规则就别用 LLM（5ms if-else 变 500ms + $0.01）。完整深度见 [主模块 · 思维范式](../../../../09.ai-applications/agent/production-stability/01-thinking-paradigm.md)。
...
- [主模块 · 思维范式](../../../../09.ai-applications/agent/production-stability/01-thinking-paradigm.md) —— 深度内容
- [主模块 · llm-production-thinking 总目录](../../../09.ai-applications/agent/production-stability/README.md)
- [主模块 · 成本 5 层路由](../../../09.ai-applications/agent/production-stability/02-cost-control-and-degradation.md)
