...
> 一句话定位：LLM 不是万能解——能用规则就别用 LLM（5ms if-else 变 500ms + $0.01）。完整深度见 [主模块 · 思维范式](../../../../agent/production-stability/01-thinking-paradigm.md)。
...
- [主模块 · 思维范式](../../../../agent/production-stability/01-thinking-paradigm.md) —— 深度内容
