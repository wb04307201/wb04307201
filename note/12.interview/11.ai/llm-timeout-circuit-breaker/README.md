...
> 一句话定位：单 timeout 一刀切让用户体验崩塌，必须双 timeout + 熔断器 + Fallback 链。完整深度见 [主模块 · 超时熔断](../../../../agent/production-stability/04-timeout-and-circuit-breaker.md)。
...
- [主模块 · 超时熔断](../../../../agent/production-stability/04-timeout-and-circuit-breaker.md) —— 深度内容
