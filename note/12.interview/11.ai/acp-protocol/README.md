...
> 一句话定位：ACP（Zed 出品 Apache 2.0）是**编辑器 ↔ Coding Agent** 的标准化通信协议，类似 LSP 对语言服务器的角色。深度原理见 [协议层深度](./context-engineering-interview/acp-protocol/README.md) + [概念地图 ACP 条目](../../../../02-technology-stack/concept-map/README.md#四-核心组件)。
...
- **概念地图**：[`concept-map.md`](../../../../02-technology-stack/concept-map/README.md) — ACP 在 Agent 协议族中的位置
