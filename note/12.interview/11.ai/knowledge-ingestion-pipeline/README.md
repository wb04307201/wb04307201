...
> ⬅️ [返回 AI 咬文嚼字](../README.md) | [主模块深度专题](../../../rag/knowledge-ingestion-pipeline/README.md)
...
- **主模块深度**：[企业级 Knowledge Ingestion Pipeline](../../../rag/knowledge-ingestion-pipeline/README.md) — 8 阶段全链路：连接、解析、清洗、分块、Embedding、入库与 CDC。
