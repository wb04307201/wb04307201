...
- 主模块：[`11.ai/05-applications`](../../../09.ai-applications/agent/case-studies/README.md) — AI 行业应用
- 故事：[`12.story/43-ai-productivity-paradox`](../../../13.story/43-ai-productivity-paradox.md)
