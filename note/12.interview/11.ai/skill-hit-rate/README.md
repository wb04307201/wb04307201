...
> **系列定位**：高频 AI 工程面试题（考察 Agent 工程化能力，非"Skill 是什么"基础题）。深度原理见 [主模块深度章节](../claude-code-practices/skill-hit-rate.md)。
...
**主模块**：
- [Skill 命中率深度章节](../claude-code-practices/skill-hit-rate.md) — 四层模型 + 五大反模式 + 实战案例
- [Skill 设计方法论深度章节](../claude-code-practices/skill-design.md) — 「写」的姐妹篇：决策树 + 6 字段 + YAML 模板
- [Claude Code 大型代码库实践](../claude-code-practices/README.md) — Skill 的"渐进式披露"基础
