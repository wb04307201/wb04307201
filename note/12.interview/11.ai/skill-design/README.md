...
> 一句话定位：**写 Skill 不是写教程**。面试官考察的不是"Skill 是什么"（基础），而是"**怎么判断该不该写 Skill / 怎么写一个能用的 Skill**"。深度方法论见 [主模块 Skill 设计章节](./claude-code-practices/skill-design.md)。
...
**主模块**：
- [Skill 设计方法论深度章节](./claude-code-practices/skill-design.md) — 决策树 + 4 阶段 + 5 反模式 + YAML 模板
- [Claude Code 大型代码库实践](./claude-code-practices/README.md) — Skill 渐进式披露基础
- [Skill 命中率深度章节](./claude-code-practices/skill-hit-rate.md) — "写"的姐妹篇："调"
