...
- 🆕 实战工具：Ralph Wiggum Loop — Fresh Context 循环 CLI
- 🆕 **Auto-Fix 闭环实战（写代码 → 跑测试 → 自动修复）**：
  - auto-fix-strategy —— 5 修复策略
  - verifier-design —— 5 大 Verifier
  - ide-case-studies —— Claude Code / Cursor / Devin / Aider
