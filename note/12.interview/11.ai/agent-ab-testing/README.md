...
> 一句话定位：**AI 场景 A/B Test = 多指标 + 流量分层 + 离线/在线双轨 + 显著性检验 + 自动决策**。完整深度 + 5 流量策略 + 3 OSS 实战见 [主模块 · agent-evaluation/02-ab-testing-design 专章](../../../09.ai-applications/agent/agent-evaluation/02-ab-testing-design/README.md)。
...
- [11.ai · agent-evaluation/02-ab-testing-design 专章](../../../09.ai-applications/agent/agent-evaluation/02-ab-testing-design/README.md) —— 完整深度 + 5 流量策略 + 3 OSS 实战 + Python 完整代码
