...
> 一句话定位：LLM 成本必须硬上限 + 自动降级，循环 bug 会 1 小时烧 $1000。完整深度见 [主模块 · 成本控制与降级](../../../09.ai-applications/agent/production-stability/02-cost-control-and-degradation.md)。
...
- [主模块 · 成本控制与降级](../../../09.ai-applications/agent/production-stability/02-cost-control-and-degradation.md) —— 深度内容
