...
> 📚 **前置知识**：[CAP 定理](../../../06.distributed-systems/02-distributed/cap-and-base/README.md) | [微服务架构](../../../06.distributed-systems/README.md)
...
- 同栏目：[`CAP 定理`](../../../06.distributed-systems/02-distributed/cap-and-base/README.md) — CAP 定理详解与工程实践
