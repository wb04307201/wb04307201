...
> 一句话定位：**系统设计面试经典题**。考察的不是"RBAC 是什么"，而是**数据模型设计** + **权限判定链路** + **缓存策略** + **审计日志** + **多租户隔离**的工程落地。完整权限模型理论见 [访问控制：6 大权限模型](../../../06.distributed-systems/05-security/access-control/README.md)。

> **系列定位**：高频系统设计题（社招必考）。配套兄弟题：[SSO 单点登录](../sso/README.md)、[JWT 安全](../../../06.distributed-systems/05-security/jwt-security/README.md)。
...
> 📖 **深度阅读**：[6 大权限模型选型指南](../../../06.distributed-systems/05-security/access-control/README.md) — DAC / MAC / RBAC / ABAC / ReBAC / 混合
...
- **权限模型理论**：[6 大权限模型](../../../06.distributed-systems/05-security/access-control/README.md) — DAC / MAC / RBAC / ABAC / ReBAC / 混合
- **RBAC 深度**：[RBAC 详解](../../../06.distributed-systems/05-security/access-control/02-role-and-attribute/rbac.md) — 角色继承 / 约束 / 权限分配
- **ABAC 深度**：[ABAC 详解](../../../06.distributed-systems/05-security/access-control/02-role-and-attribute/abac.md) — 策略引擎 / 属性表达式
