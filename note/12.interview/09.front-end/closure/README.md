...
> **一句话定位**：闭包 = 函数 + 词法作用域：私有变量 / 柯里化 / 防抖节流三件套，警惕循环与 React Hooks 陷阱。
...
> 📚 **前置知识**：[JavaScript 基础](../../../05.frontend/02-language/README.md)
...
> 📅 2026-09-01 · 咬文嚼字 · closure · ⭐⭐⭐（中频面试 + 实战必会）

← [返回: 咬文嚼字 · closure](../README.md)
