...
> **一句话定位**：手写 Promise 考察状态机 + 微任务 + 链式调用，是 JS 异步面试的试金石。
...
- 相关：[`12.interview/09.front-end/event-loop/`](../event-loop/) — 事件循环（Promise 是微任务）
- 相关：[`12.interview/09.front-end/closure/`](../closure/) — 闭包（Promise 内部状态保存）
- 🆕 [12.interview/09.front-end/async-await-try-catch](../async-await-try-catch/) —— async/await 错误处理 4 方式 + 5 反模式

## 相关章节

- 深度阅读：[`05.frontend`](../../../05.frontend/README.md) — 主模块详细内容

> 📅 2026-09-01 · 咬文嚼字 · promise-handwriting · ⭐⭐⭐⭐（中频面试 + 实战必会）
