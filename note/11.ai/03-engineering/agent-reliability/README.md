...
**设计参考**：[Verifier 设计](../loop-engineering/verifier-design.md)
...
结合 LLM 监控做实时追踪：[在线监控](../../08-llmops/production-stability/05-online-monitoring.md)
...
- [Loop Engineering](../loop-engineering/README.md) — 循环调用 3 大组件 + 4 大失败模式
- [Harness Engineering](../harness-engineering/README.md) — 4 大 Harness 类型 + 4 原则
- [Verifier 设计](../loop-engineering/verifier-design.md) — Verifier 组件设计详解

### 咬文嚼字

- [Agent 可靠性面试题](../../../13.split-hairs/11.ai/agent-reliability/README.md) — 5 大陷阱 + 4 层防线速查

### 监控与稳定性

- [在线监控](../../08-llmops/production-stability/05-online-monitoring.md) — 4 维监控 + Trace
