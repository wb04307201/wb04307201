...
| # | 文件 | 一句话定位 |
|---|------|-----------|
| 1 | [Ralph Wiggum Loop](ralph-wiggum-loop.md) | Fresh Context 循环的开源 CLI 实现 |
| 2 | [Auto-Fix 修复策略](auto-fix-strategy.md) | 5 种按错误类型分发的修复策略 |
| 3 | [Verifier 设计](verifier-design.md) | 5 大客观验证源（测试/Lint/类型/构建/运行） |
| 4 | [IDE 实战案例](ide-case-studies.md) | 4 大 AI IDE Loop 工程实战案例 |
| 5 | [修复 Prompt 模板](fix-prompt-templates.md) | 4 类常用修复 Prompt 模板 |
