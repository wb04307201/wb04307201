...
## 八、实战模式：Ralph Wiggum Loop

> 概念看完了，怎么落地？👉 [Ralph Wiggum Loop — Fresh Context 循环模式](ralph-wiggum-loop.md)
>
> 每轮 fresh context，Agent 忘记一切，只靠磁盘文件理解世界。一行 bash 即可实现。
...
| 2 | [Ralph Wiggum Loop](ralph-wiggum-loop.md) | Fresh Context 循环模式：概念 + 最小实现（一行 bash） |
