...
- **L2 栈**：[KV Cache](../../02-technology-stack/kv-cache/README.md)（推理复杂度 + MQA/GQA/MLA 对比） / [PagedAttention](../../02-technology-stack/paged-attention/README.md) / [推理性能指标](../../02-technology-stack/inference-metrics/README.md)
