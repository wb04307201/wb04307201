...
**同主模块（实证篇）**：
- [单 epoch 时代 + config 考古实锤](single-epoch-and-config-evidence.md) — 本文「原理」的姐妹篇：「实证」—— 单 epoch 4 层面 + 6 里程碑模型 config 考古（GPT-3 / LLaMA / Mistral / Qwen / DeepSeek）
...
- **关联章节**：3 大类（面试题 + 主模块 + 实证篇姐妹 [single-epoch-and-config-evidence](single-epoch-and-config-evidence.md)）

---

> 📅 2026-07-02 · 11.ai/01-fundamentals · ⭐⭐⭐⭐

← [返回: AI 知识体系 · dropout-in-llm](README.md)
