...
> 13 节课 · 5 个阶段 · 覆盖 LLM / Prompt / RAG / MCP / Skills / 多智能体 / Agent 设计 / 工程实践
...
| 2 | [Agent Harness 与控制论](lession2/README.md) | 为什么 2026 年的竞争焦点从模型能力转向系统可靠性？ | 90 min |
...
| 10 | [Agent 评估方法论](lession10/README.md) | 如何系统性地评估 Agent 的质量？ | 85 min |
...
### 🔬 深度研究路线（约 12 小时）
```
第 1 课 → 第 2 课 → 第 3 课 → 第 4 课 → 第 5 课 → 第 6 课 → 第 8 课 → 第 10 课
```
