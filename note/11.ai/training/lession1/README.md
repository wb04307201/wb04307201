...
> 正如中医的《内经》提出的"君臣佐使"的处方原则, 四者的正确"配伍"协才能解决病症的"方剂"  
> **👑 君药 · 大模型（LLM）**  
> *"主病之谓君"——治病主力*
> - **核心地位**：提供语言理解、逻辑推理、内容生成等基础能力
> - **不可替代**：模型参数规模与训练质量决定系统能力上限
> - **使用原则**：选对"君药"（模型）是成功的前提，如辨证选方
> 
> **‍⚕️ 臣药 · 提示词工程（Prompt）**  
> *"佐君之谓臣"——辅助增效*
> - **协同机制**：通过指令设计、思维链、角色设定等，激发模型潜能
> - **增效原理**：无需调整模型参数，即可显著提升输出质量
> - **配伍要点**：好的提示词如良臣，能让"君药"发挥1+1>2的效果
> 
> **🌿 佐药 · 知识库**
> *"应臣之谓佐"——调和纠偏*
> - **调和作用**：用外部知识校正模型"记忆偏差"，减少事实性错误
> - **减毒功能**：限制模型在未知领域"妄言"，降低幻觉风险
> - **兼证处理**：针对垂直领域问题，提供专业精准的补充信息
> 
> **🚀 使药 · MCP协议**
> *"引经报使"——通达四方*
> - **引经作用**：标准化连接文件、数据库、API等外部资源
> - **报使功能**：让模型"知道"何时调用何工具，如何传递上下文
> - **调和诸药**：统一接口规范，使君臣佐各司其职、协同无碍
