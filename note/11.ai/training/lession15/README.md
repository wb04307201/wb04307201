...
- 前置课程：[第 14 课：AI 时代的认知债务与深度工作](../lession14/README.md)
- 知识准备：理解 AI Agent 的核心架构和多智能体协同模式
- 推荐阅读：[第 6 课：多智能体协同](../lession6/README.md)、[第 8 课：Agent 设计模式与架构](../lession8/README.md)
...
```
第一章（方法论框架）  →  第二章（架构愿景）  →  第三章（管理警示）
     ↑                       ↑                      ↑
  怎么做？             终极形态是什么？        什么不能做？
```

- **快速了解**：先读第二章 + 第三章（约 50 分钟），理解 AI 原生组织的机遇与陷阱
- **创始人/管理者**：通读全部三章，重点关注第一章的四阶段实操练习
- **技术负责人**：重点阅读第二章的五层循环架构和 AI 可读性设计
...
⬅️ 上一课：[AI 时代的认知债务与深度工作](../lession14/README.md) | ➡️ 下一课：[LLM 驱动的个人知识库](../lession16/README.md)
