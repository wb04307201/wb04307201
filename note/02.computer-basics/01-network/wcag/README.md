...
module:
  ...
  type: article
  category: 主模块子文章
  summary: WCAG - 网页内容无障碍指南 本应该很简单，- **全称**：Web Content Accessibility Guidelines（网页内容无障碍指南）
-->
...
WCAG - 网页内容无障碍指南 本应该很简单，- **全称**：Web Content Accessibility Guidelines（网页内容无障碍指南）
