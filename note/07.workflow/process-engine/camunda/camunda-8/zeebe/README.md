...
> 最后更新: 2026-06-14
> ⬅️ [返回 07 工作流](README.md) | [流程引擎](process-engine/README.md) | [Camunda 8](process-engine/camunda/camunda-8/README.md)
...
- [Camunda 8](process-engine/camunda/camunda-8/README.md) — Zeebe 是 Camunda 8 的内核
- [Camunda 7 实战](process-engine/camunda/camunda-7/README.md) — 上一代 Java 嵌入式引擎
- [工作流引擎与微服务编排](workflow-and-microservice-orchestration/README.md) — Zeebe/Conductor/Cadence 三大编排引擎
