...
> 最后更新: 2026-06-14
> ⬅️ [返回 AI 工作流](README.md) | [Dify](dify.md) | [Coze](coze.md) | [LangGraph](langgraph.md) | [Camunda 8](../process-engine/camunda/camunda-8/README.md) | [07 工作流](../README.md)
...
- [Dify](dify.md) — 模式 A/B 中 LLM 推理的常见载体
- [LangGraph](langgraph.md) — 模式 B/C 中 Agent 框架的工业界主流
- [Camunda 8](../process-engine/camunda/camunda-8/README.md) — 模式 A 8.5+ AI Agent Sub-process 详解
- [Zeebe](../process-engine/camunda/camunda-8/zeebe/README.md) — 模式 B Zeebe AI Worker 实现
- [微服务编排](../workflow-and-microservice-orchestration/README.md) — 流程引擎在微服务场景的演化
