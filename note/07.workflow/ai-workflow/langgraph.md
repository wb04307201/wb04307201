...
> 最后更新: 2026-06-14
> ⬅️ [返回 AI 工作流](README.md) | [Dify](dify.md) | [Coze](coze.md) | [AI + BPMN 融合](bpmn-ai-integration.md) | [07 工作流](../README.md)
...
5. **LangGraph 会被 BPMN 取代吗？** 不会。两者解决不同问题——LangGraph 服务于"快速试错 + 复杂推理"；BPMN 服务于"确定性 + 合规审计"。**生产中常组合**（详见 [AI + BPMN 融合](bpmn-ai-integration.md)）。
...
- [AI + BPMN 融合](bpmn-ai-integration.md) — LangGraph + Camunda 8 混合架构（生产级落地）
