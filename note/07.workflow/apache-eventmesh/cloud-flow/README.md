...
> 最后更新: 2026-06-14
> ⬅️ [返回 07 工作流](README.md) | [Apache EventMesh](apache-eventmesh/README.md)
...
- [Apache EventMesh](apache-eventmesh/README.md) — 事件驱动编排的开源实现
- [工作流引擎与微服务编排](workflow-and-microservice-orchestration/README.md) — 工作流引擎架构演进
