...
| 维度 | 数据 |
|------|------|
| **覆盖节数** | 4 节（SpringBoot 集成 / 任务节点 / 对比 / 案例） |
| **任务节点** | 5（User / Manual / Service / Send / Receive） |
| **数据库表前缀** | 4（ACT_ID / ACT_HI / ACT_RE / ACT_RU / ACT_GE） |
| **真实案例** | 1（银行业 50 万件/年信贷审批） |

← [返回 07 工作流](../../../README.md)

<!-- TODO: 拆分候选 (519 行 / 10 个 H2，超 500+8 阈值） -->
