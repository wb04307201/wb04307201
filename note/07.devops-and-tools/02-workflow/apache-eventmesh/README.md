...
5. **事件驱动工作流的最大风险？** **事件丢失 / 重复消费 / 顺序错乱**——必须有**幂等设计**（详见 [04 系统设计/06 幂等](../../../06.distributed-systems/06-idempotency/README.md)）+ **死信队列** + **事件版本管理**。
...
- [04 系统设计/02 分布式](../../../06.distributed-systems/02-distributed/README.md) — CAP/共识理论基础
...
| **典型规模** | 12306 春运日均千万级票量；QPS **未公开核实 — 建议生产前实测**（参考量级：RocketMQ 单机 ~10 万 TPS / Kafka 单机 ~20 万 TPS）|

> ⚠️ 与 [§5.1 数据声明](#五12306-案例架构假设性示例) 一致：本文所有 12306 精确 QPS/峰值数字均无可点击官方来源，仅作架构示例。
