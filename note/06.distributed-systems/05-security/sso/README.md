...
> **定位**：单点登录（SSO）深度专题 —— 6 大实现方案对比（CAS/OAuth2/OIDC/SAML/Cookie/JWT）+ Spring Security 实战 + 选型决策 的核心原理、实现与最佳实践。
...
完整 5-7 道精选面试题见 [12.interview/05.security/sso](../../../12.interview/05.security/sso/README.md)。
