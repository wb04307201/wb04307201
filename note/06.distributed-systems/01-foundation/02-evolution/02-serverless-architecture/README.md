<!--module:
  ...
  slug: 12.interview/04.system-design/01-foundation/02-evolution/02-serverless-architecture
  type: article
  category: 主模块子文章
...
Serverless 架构：FaaS / BaaS / Knative 全场景实战 的关键不是'选型'——是**选完之后怎么在 5 个 trade-off 里活下来**。

本篇从主流路径的取舍切入，比较几种主流路径并讲清取舍。
