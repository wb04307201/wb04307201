...
详见 [`11.ai/08-llmops`](../../../09.ai-applications/agent/README.md)
...
🆕 **微服务 vs 单体核心优势对比**：[system-design-basics/microservices/ 专题](../system-design-basics/microservices/README.md) —— 6 大核心优势（独立部署 / 独立伸缩 / 技术异构 / 故障隔离 / 团队自治 / 可演进）+ 6 大反模式 + Java Spring Cloud 7 维对比 + 何时该拆 7 维决策。面试精选 7 道 Q&A 见 [13.split-hairs/04.system-design/microservices-vs-monolith](../../../12.interview/04.system-design/microservices-vs-monolith/README.md)。