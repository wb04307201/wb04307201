...
> **一句话定位**：分布式 ID 解决多节点全局唯一标识难题，UUID、Snowflake、Leaf、Redis 自增是主流方案，要权衡有序性与性能。
...
> 🔗 **应用场景**：[`短链系统设计`](../../../12.interview/04.system-design/url-shortener/README.md) — Snowflake + Base62 生成短码 + 302 重定向 + 缓存
