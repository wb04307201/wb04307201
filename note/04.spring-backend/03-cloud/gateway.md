...
> 📌 本节展示 Gateway 层的鉴权**接入点**与**上下文透传**。JWT 签发、密钥管理、OIDC 流程详见 [04.system-design/05-security/oauth2-oidc/](../../06.distributed-systems/05-security/oauth2-oidc/README.md) 与 [04.system-design/05-security/jwt-security/](../../06.distributed-systems/05-security/jwt-security/README.md)。
