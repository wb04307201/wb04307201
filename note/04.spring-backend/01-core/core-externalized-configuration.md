...
module:
  ...
  slug: 04.spring-backend\01-core\core-externalized-configuration
  type: article
  category: 主模块子文章
...
- [Spring Boot 外部化配置](../02-boot/boot-externalized-configuration.md) — application.yml 加载顺序、spring.config.import
