...
- [12.interview/04.system-design/07-deployment/observability](../../06.distributed-systems/07-deployment/observability/README.md) — 监控体系理论（SLO/Error Budget/USE/RED 全局视角）

> 💡 **理论/全局视角见 `12.interview/04.system-design/07-deployment/observability`**（SLO、Error Budget、USE、RED 等方法论）；**本文档聚焦 Spring 实现细节**。
