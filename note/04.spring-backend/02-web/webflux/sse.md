...
- 🆕 面试视角：[SSE vs WebSocket —— AI 对话为什么选 SSE](../../../12.interview/02.computer-basics/sse-vs-websocket/README.md) — 协议对比 + 系统设计选型
- 🆕 协议深度：[SSE vs WebSocket 协议对比](../../../02.cs-foundations/03-network/protocols/sse-vs-websocket/README.md) — 连接建立 + 帧格式 + 重连机制
