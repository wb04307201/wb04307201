...
本节是 Spring Cache 注解的速查手册——`@Cacheable` / `@CachePut` / `@CacheEvict` / `@Caching` / `@CacheConfig` 的关键属性与 SpEL 语法。**深读请前往 [04-data/cache](../../README.md)**。
...
- [04-data/cache/README](../../README.md) — 缓存完整指南
- [04-data/cache/patterns](../04-data/cache/patterns.md) — Cache-Aside、Read-Through 等模式
- [04-data/cache/serialization](../04-data/cache/serialization.md) — 缓存序列化
- [04-data/cache/multi-level](../04-data/cache/multi-level.md) — 多级缓存
