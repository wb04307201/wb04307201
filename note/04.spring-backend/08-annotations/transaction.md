...
module:
  ...
  slug: 04.spring-backend\08-annotations\transaction
  type: article
  category: 主模块子文章
  summary: 待补充
-->
...
本节是 `@Transactional` 与 `@EnableTransactionManagement` 的速查手册——只列关键属性与失效场景，**深读请前往 [04-data/transaction](../../README.md)**。
...
- [04-data/transaction/README](../../README.md) — 事务完整指南
- [04-data/transaction/failure-cases](../04-data/transaction/failure-cases.md) — 事务失效场景详解
- [04-data/transaction/propagation-and-isolation](../04-data/transaction/propagation-and-isolation.md) — 传播与隔离级别深入
- [04-data/transaction/jpa-transaction](../04-data/transaction/jpa-transaction.md) — JPA 事务特性
