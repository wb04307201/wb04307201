...
> ⬅️ [返回: 02.computer-basics 综述](../README.md) | [主模块: decision-tree](../../../02.computer-basics/02-algorithms/decision-tree/README.md)
...
- **主模块**：[`02-algorithms/decision-tree`](../../../02.computer-basics/02-algorithms/decision-tree/README.md) — 决策树原理深度（含 CART 推导）
