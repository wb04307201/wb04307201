...
> ⬅️ [返回: 02.computer-basics 综述](../../README.md) | [主模块: ensemble](../../../../02.computer-basics/02-algorithms/ensemble/README.md)
...
- **主模块**：[`02-algorithms/ensemble`](../../../../02.computer-basics/02-algorithms/ensemble/README.md) — 集成学习原理（含 Boosting 推导）
