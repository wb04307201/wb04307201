...
|------|-----|------|
| 参数放哪？ | URL | Body |
| 有长度限制？ | 有（URL 长度限制） | 理论上无 |
| 能缓存？ | ✅ | ❌（默认） |
| 安全？ | 参数暴露在 URL | 相对安全 |
| 幂等？ | ✅ | ❌ |
| 能收藏书签？ | ✅ | ❌ |

GET 和 POST 的区别是面试高频题。但很多人只记得"GET 取数据，POST 提交数据"——远远不够。

从**本质**上看，GET 和 POST 的差异体现在：缓存、幂等性、参数位置、安全性、浏览器行为等 9 个维度。

---

> 📚 **前置知识**：[HTTP 缓存](../../09.front-end/http-cache/README.md)
...
理解 GET 和 POST 的差异有助于设计更安全、高效的 Web 应用和 API。## 相关章节

- 深度阅读：[`02.computer-basics/01-network`](../../../02.computer-basics/01-network/README.md) — HTTP 协议详解
- 相关：[`13.split-hairs/from-url-to-page`](../from-url-to-page/README.md) — 从 URL 到页面展示全链路

← [返回: 咬文嚼字 · get-and-post](README.md)
