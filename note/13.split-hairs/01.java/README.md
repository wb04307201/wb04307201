...
> Java 高频面试题与细节深挖，对齐主模块 [`01.java`](../../01.java/)。41 篇分集合 / 并发 / JVM / 语言基础 / 对象类型 / 设计模式 / 综合 7 组（find 校对 2026-07-27），覆盖 90% 后端面试 Java 高频题。

---

## 文章清单（共 41 篇，find 校对 2026-07-27）
...
| 主题 | 难度 | 核心问题 |
|------|------|---------|
| [高频面试题合集](questions/) | ⭐⭐⭐⭐⭐ | Java 综合高频问题深度解析（原理 → 演进 → 场景 → 权衡） |
