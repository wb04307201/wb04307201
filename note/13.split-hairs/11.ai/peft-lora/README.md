...
> ⬅️ [返回 AI 咬文嚼字](../README.md) | [主模块深度专题](../../../11.ai/07-research/alignment/06-peft-lora.md)
...
- **主模块深度**：[PEFT / LoRA / QLoRA 深度专题](../../../11.ai/07-research/alignment/06-peft-lora.md) — 4 大方法完整版 + DoRA/AdaLoRA/LoRA+/LongLoRA 2024-2026 新方法
