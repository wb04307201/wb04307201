...
| **🆕 [KV Cache + MQA/GQA/MLA](kv-cache-mqa-mla/)** | ⭐⭐⭐⭐ | O(n³)→O(n²) 复杂度 + 3 种 KV 共享方案对比（显存/精度/训练 trade-off） | [02-technology-stack/kv-cache](../../11.ai/02-technology-stack/kv-cache/README.md) |
