...
| **🆕 [Agent 跑偏/死循环](agent-reliability/)** | ⭐⭐⭐⭐ | 5 大陷阱 + 4 层防护（Prompt 约束 / Verifier 检测 / 状态回滚 / 成本熔断） | [03-engineering/agent-reliability](../../../11.ai/03-engineering/agent-reliability/README.md) |
| **🆕 [KV Cache + MQA/GQA/MLA](kv-cache-mqa-gqa-mla/)** | ⭐⭐⭐⭐ | O(n³)→O(n²) 复杂度 + 3 种 KV 共享方案对比（显存/精度/训练 trade-off） | [02-technology-stack/kv-cache](../../../11.ai/02-technology-stack/kv-cache/README.md) |
