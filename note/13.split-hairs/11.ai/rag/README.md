...
- 深度原理：[Agentic Search vs RAG](../../../11.ai/02-technology-stack/agentic-search-vs-rag/README.md)
...
> 🔗 深度原理：[`RAG 范式演进四阶段`](../../../11.ai/02-technology-stack/rag-paradigm-evolution/README.md) — 每阶段核心能力/关键技术/局限 + 对比表 + 选型决策树 + 与 5 阶段 Pipeline 正交关系澄清
