...
> 一句话：RDB 是内存快照，AOF 是命令日志，混合持久化结合两者优势——用 RDB 做快速恢复基线，用 AOF 增量保证数据完整性。
...
- 相关：[数据结构](../redis-data-structures/)、[高可用](../redis-ha-architecture/)、[集群](../redis-cluster/)、[MySQL vs Redis](../mysql-vs-redis/)
