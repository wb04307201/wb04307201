...
> 一句话：B+ Tree 通过非叶子节点只存键、叶子节点成链的结构，将树高压缩到 3-4 层，使得千万级数据只需 3-4 次磁盘 IO 即可完成查询。
...
- [分库分表](../../../../04.system-design/04-high-performance/database-optimization/db-sharding/README.md) — 数据库分库分表策略
