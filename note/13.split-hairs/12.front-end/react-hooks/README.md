...
- 相关：[`13.split-hairs/12.front-end/event-loop/`](../event-loop/) — 事件循环（useEffect 执行时机）
- 相关：[`13.split-hairs/12.front-end/closure/`](../closure/) — 闭包（Hooks 本质）
- 相关：[`13.split-hairs/12.front-end/virtual-dom-diff/`](../virtual-dom-diff/) — Virtual DOM（Fiber 架构）
