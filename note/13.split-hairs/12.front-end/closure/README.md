...
- 相关：[`13.split-hairs/12.front-end/event-loop/`](../event-loop/) — 事件循环（闭包配合异步）
- 相关：[`13.split-hairs/12.front-end/promise-handwriting/`](../promise-handwriting/) — Promise 实现（闭包应用）
