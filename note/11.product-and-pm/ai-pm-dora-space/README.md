...
### 真实案例（用 [12.story/45](../../13.story/43-ai-productivity-paradox.md) 的数据）
...
- [ ] **架构债 / 认知债** —— 同时看 [12.story/29-codebase-cognitive-debt](../../13.story/29-codebase-cognitive-debt.md)
- [ ] **组织能力评估** —— 用 SPACE 中"沟通 / 协作"维度，结合 [12.story/07-from-chef-to-ceo](../../13.story/07-from-chef-to-ceo.md)
...
- 故事章节：[`12.story/43-ai-productivity-paradox`](../../13.story/43-ai-productivity-paradox.md) — Waydev/GitClear/Faros/Jellyfish 数据
