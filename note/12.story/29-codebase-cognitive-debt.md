...
## 第一章：什么是 Codebase 认知债 —— 技术债机器痛，认知债人的痛
...
## 第二章：认知债的 4 大来源 —— 规模、一致、时序、隐式四本糊涂账
...
## 第五章：AI 时代为什么认知债更危险 —— AI 写代码快，加速混乱也快
...
## 第六章：6 大降低认知债的策略 —— 从代码宪法到活文档，工程化还债
...
- [厨房实况直播](./19-realtime-eventdriven.md) —— 异步消息的设计决策尤其需要 ADR，否则时序债最严重
- [懂你的菜单](./21-search-recommendation.md) —— 搜索/推荐算法策略是"最难写但最有价值"的文档，认知债最重灾区
- [会自我进化的厨房](./27-self-evolving-company.md) —— Agent Loop 中的"可读性"是 AI 时代组织的基础设施
- [AI 的"黑暗料理"](./28-ai-hallucination-safety.md) —— AI 幻觉与认知债：AI 在认知债严重的代码上幻觉率显著上升
...
- [30-ai-hallucination-safety.md](./28-ai-hallucination-safety.md) —— 续集六，认知债严重的代码加剧 AI 幻觉：上下文噪音让 AI 输出更易出错
...
- 续集二十：[`46-tech-debt-career-trap`](./44-tech-debt-career-trap.md) —— **技术债如何把个人困死**：本篇讲"代码/团队"侧的技术债，续集 20 讲"个人职业"侧的技术债
- 续集十九：[`45-ai-productivity-paradox`](./43-ai-productivity-paradox.md) —— **AI 时代的代码流失率**：DORA 放大器理论告诉你为什么认知债在 AI 时代更严重
