...
module:
  ...
  category: 主模块
  summary: 用开餐厅的故事讲明白 47 篇技术文章，覆盖传统工程 25 篇 + AI 时代 22 篇（续集一 + 续集二-二十 + 番外七/八），篇篇独立又互相串联。
-->

# 「阿明餐厅」技术系列

> 用开餐厅的故事，讲明白四十七篇技术大事 —— 从架构演进到 AI 智能体，从流量治理到 AI 私有化部署。

本系列按**叙事逻辑**组织（**前传 → 续集一 → 正传 → 终章 → 番外 → 续集二十**），每篇标注文件编号方便检索。原编号 17 / 23 已合并到相邻主题（17 并入 18-distributed-puzzles，23 并入 24-database-migration），故编号从 16 直接跳到 18、从 22 跳到 24，但**总篇数仍是 47 篇**：44 个叙事段中，34 / 35 / 36 各含 2 个子文件（a / b），故实际 `.md` 文件共 **47 个**（44 段 + 3 个拆分）。
...
本系列**只有顶层结构，无子目录分类**（按故事叙事而非按主题分目录，47 篇文章平铺于顶层）。下列 7 个集群由浅入深、由传统到 AI：
...
| 正传 11-14 · 系统进阶 | 4 | [20](./20-realtime-eventdriven.md) / [18](./18-distributed-puzzles.md) / [21](./21-multiplatform-architecture.md) / [24](./24-database-migration.md) | 异步 / 分布式 / 多端 / 数据库迁移 |
| 终章 · 组织管理 | 1 | [07](./07-from-chef-to-ceo.md) | 从厨师到 CEO，500 人像 5 人协作 |
| 番外 · 专题拓展 | 8 | [03](./03-refactoring-guide-for-pm.md) / [14](./14-cloud-finops.md) / [19](./19-saas-multitenant.md) / [22](./22-search-recommendation.md) / [25](./25-lowcode-platform.md) / [26](./26-globalization.md) / [42](./42-prompt-engineering.md) / [43](./43-multimodal-ai.md) | 重构 / FinOps / SaaS / 搜索 / 低代码 / 国际化 / Prompt / 多模态 |
| 续集 2-20 · AI 时代 | 22 | [11](./11-ai-learning-paradox.md) ~ [46](./46-tech-debt-career-trap.md)（含 [34a](./34a-ai-evaluation-fundamentals.md) / [34b](./34b-ai-evaluation-pipeline.md) / [35a](./35a-mcp-protocol.md) / [35b](./35b-a2a-protocol.md) / [36a](./36a-ai-token-cost-structure.md) / [36b](./36b-ai-token-cost-optimization.md)） | AI 时代 22 大主题 |
| **合计** | **47** | — | 44 叙事段 + 3 个 a/b 拆分 |
...
| [一页纸速查](./cheatsheet.md) | 47 篇文章核心概念 + 关键决策表 + 金句心法 |
...
- **2026 三大热点（3 小时）**：续集十九 [45 生产力悖论](./45-ai-productivity-paradox.md) → 续集十八 [44 谁负责](./44-ai-engineer-responsibility.md) → 续集二十 [46 技术债困局](./46-tech-debt-career-trap.md)
...
| 三 | AI 组织转型 | [27](./27-ai-org-transformation.md) | 自动化的本质是换岗不是省人 |
| 四 | AI 原生创业 | [28](./28-ai-native-startup.md) | 智能体工作流替代创始人注意力 |
| 五 | 自我进化组织 | [29](./29-self-evolving-company.md) | 公司是 Agent Loop 不是金字塔 |
| 六 | AI 幻觉护栏 | [30](./30-ai-hallucination-safety.md) | 三层护栏 + 信任校准 |
| 七 | Codebase 认知债 | [31](./31-codebase-cognitive-debt.md) | AI 时代最大的隐形负债 |
| 八 | Agent Harness | [32](./32-agent-harness.md) | Harness 是 Agent 时代操作系统 |
| 九 | 致命三件套 | [33](./33-ai-fatal-trio.md) | 注入 / 越权 / 泄露协同致命 |
| 十 | AI 评测 | [34a](./34a-ai-evaluation-fundamentals.md) / [34b](./34b-ai-evaluation-pipeline.md) | 6 大维度 + 5 层流水线 |
| 十一 | MCP / A2A 协议 | [35a](./35a-mcp-protocol.md) / [35b](./35b-a2a-protocol.md) | AI 时代 TCP/IP |
| 十二 | Token 经济学 | [36a](./36a-ai-token-cost-structure.md) / [36b](./36b-ai-token-cost-optimization.md) | 看不见的成本最可怕 |
| 十三 | AI 可观测性 | [37](./37-ai-observability.md) | 3 传统支柱 + 4 AI 支柱 = 7 支柱 |
| 十四 | RAG | [38](./38-rag-retrieval-augmented-generation.md) | 幻觉率 29% → 3% |
| 十五 | 向量数据库 | [39](./39-vector-database-and-embedding.md) | 6 大向量库选型 |
| 十六 | AI 合规 | [40](./40-ai-compliance-and-regulation.md) | EU AI Act / GDPR / PIPL |
| 十七 | AI 私有化 | [41](./41-ai-private-deployment.md) | 3 年回本是黄金线 |
| 十八 | AI 责任 | [44](./44-ai-engineer-responsibility.md) | 系统责任金字塔 + 4 大岗位重定义 |
| 十九 | 生产力悖论 | [45](./45-ai-productivity-paradox.md) | DORA 放大器理论 |
| 二十 | 技术债困局 | [46](./46-tech-debt-career-trap.md) | 救火 3 年不如建设 1 年 |

### 3.3 三大热点（2026 必读）

| 续集 | 主题 | 核心数据 |
|------|------|----------|
| **十九** | [AI 提速 3 倍，交付反而慢了？](./45-ai-productivity-paradox.md) | 提交量 +217% / bug +383% / 事故 +200% / Token 涨 5 倍 |
| **十八** | [AI 替你写代码，谁替系统负责？](./44-ai-engineer-responsibility.md) | 1 AI 工程师代 10 传统工程师，3 起事故赔 13 万 |
| **二十** | [你接手的烂代码，正在决定你哪天被淘汰](./46-tech-debt-career-trap.md) | 28 岁入职 31 岁简历空，4 判断标准 + 4 增值动作 |
...
| 编号 | 主题 | 一句话 |
|------|------|--------|
| [20](./20-realtime-eventdriven.md) | 厨房实况直播 | MQ + EDA + 事件溯源 + CDC + WebSocket |
| [18](./18-distributed-puzzles.md) | 十家店的烦恼 | CAP + 分布式锁 + 幂等性 + 脑裂 + 雪花算法 |
| [21](./21-multiplatform-architecture.md) | 一个厨房四个门面 | BFF + 跨平台 + 离线优先 + 多端发布 |
| [24](./24-database-migration.md) | 仓库搬家不停业 | 在线 DDL + 双写迁移 + 影子表 + 分库分表 |
...
| [19](./19-saas-multitenant.md) | 阿明的加盟帝国 | 多租户 + 数据隔离 + 租户路由 + 计费模型 |
| [22](./22-search-recommendation.md) | 懂你的菜单 | 倒排索引 + 协同过滤 + 向量检索 + AB 测试 |
| [25](./25-lowcode-platform.md) | 预制菜还是现炒 | 低代码 + Escape Hatch + 隐性成本 + 平台锁定 |
| [26](./26-globalization.md) | 阿明出海记 | i18n / l10n + 时区 + 多币种 + GDPR / PIPL / APPI |
| [42](./42-prompt-engineering.md) | 点菜单的艺术 | 10 大 Prompt 模式 + 7 高级技术 + 4 优化 |
| [43](./43-multimodal-ai.md) | 五感餐厅 | 5 大模态 + 3 融合架构 + 6 模型 + 5 场景 |
...
| **AI 编码落地** | 先读 [续集 7 认知债](./31-codebase-cognitive-debt.md) → [续集 8 Harness](./32-agent-harness.md) → [续集 9 致命三件套](./33-ai-fatal-trio.md) 再上手 |
| **架构评审** | 引用 [前传 第二章 IT 成熟度](./02-system-architecture-evolution.md) L1-L7 对标当前阶段 |
| **AI 成本治理** | 读 [36b Token 优化](./36b-ai-token-cost-optimization.md) + [续集 5 自进化](./29-self-evolving-company.md) 监控 Agent Loop |
...
| **个人职业发展** | 读 [46 技术债困局](./46-tech-debt-career-trap.md) → [45 生产力悖论](./45-ai-productivity-paradox.md) → [44 谁负责](./44-ai-engineer-responsibility.md) |
...
| 微服务拆分的依据是什么？ | [前传 02](./02-system-architecture-evolution.md) / [正传 12](./18-distributed-puzzles.md) | 康威定律 / DDD / CAP |
...
| Agent Harness 的 4 大模块？ | [续集 8](./32-agent-harness.md) | Context / Tool / Memory / Guardrails |
| AI 致命三件套是哪三件？ | [续集 9](./33-ai-fatal-trio.md) | 注入 / 越权 / 泄露 |
| RAG 5 大核心环节是什么？ | [续集 14](./38-rag-retrieval-augmented-generation.md) | Query / Retrieval / Postprocess / Prompt / Generate |
...
| 维度 | 数字 |
|------|------|
| 顶层文章数（叙事篇数） | 44 段 + 3 个 a/b 拆分 = **47 篇** |
