...
3. **查速查（按场景）** → 需要时翻 [cheatsheet.md](./cheatsheet.md)（一页纸核心决策表）或 [glossary.md](./glossary.md)（320+ 术语速查）
...
**速查入口**
- 📋 [一页纸速查](./cheatsheet.md) —— 44 篇文章的核心概念 + 关键决策表 + 金句心法
- 📖 [术语表](./glossary.md) —— 320+ 术语，按 47 大主题分类
...
- [术语表](./glossary.md) —— 320+ 词条速查，按 47 大主题分类
