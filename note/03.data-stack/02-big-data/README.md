...
- **上游基础**：[02.cs-foundations](../../02.cs-foundations/README.md)（网络 / Linux / 算法）
- **存储相关**：[01-database](../01-database/README.md)（MySQL / Redis）
- **实时引擎**：与 [04.spring-backend](../../04.spring-backend/README.md) 集成（CDC / 实时数仓）
- **应用展示**：[09.ai-applications](../../09.ai-applications/README.md)（LLM 训练数据湖 / 实时特征）
- **架构方法**：[06.distributed-systems](../../06.distributed-systems/README.md)（分布式 / 高可用）
