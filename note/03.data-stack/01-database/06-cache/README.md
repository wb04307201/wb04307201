...
- **面试题（通用策略）**：[13.split-hairs/04.system-design/high-performance/cache-consistency](../../../12.interview/04.system-design/cache-consistency/README.md) —— 244 行深度，Java 后端必问。
- **主模块深度（Java 后端视角）**：[04.system-design/04-high-performance/cache-patterns/#java 后端实战章节](../../../06.distributed-systems/04-high-performance/cache-patterns/README.md) —— 253 行，5 大 Spring 注解陷阱 + 多级缓存 + 反模式深度。
