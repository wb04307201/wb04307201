...
- **核心定位**：把 IT 部门的服务交付、事件管理、变更控制系统化的平台，是 IT 部门的"ERP"，核心框架是 ITIL 4
- **关键能力**：服务台 / 事件管理 / 问题管理 / 变更管理 / SLA / CMDB / 知识库 / 服务请求
- **典型场景**：跨国集团 IT 运维、金融/政府合规 ITSM、互联网科技公司敏捷 ITSM、制造业 IT 服务台
- **关键考量**：CMDB 治理是核心（黑洞陷阱）、SLA 必须基于能力评估、与监控告警/HR/OA 边界需明确
...
| ITSM | IT 服务管理（IT 部门的"ERP"，核心框架是 ITIL 4） | [ITSM 深读](./itsm/) |
