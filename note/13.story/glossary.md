...
> 「阿明餐厅」系列涉及的 340+ 个核心技术术语速查，按 48 大主题分类。每条包括：术语名称、一句话解释、出处文章。
...
| 术语 | 解释 | 出处 |
|------|------|------|
| **老板幻觉 (Boss Hallucination)** | 管理者盲目信任 AI 输出，基于错误信息做战略/人事/产品决策，导致资源错配或人才流失 | [续集二十一](./47-boss-hallucination.md) |
| **组织幻觉 (Organizational Hallucination)** | AI 幻觉在组织层面被放大——不是模型出错的问题，而是决策传导链把错误放大的问题 | [续集二十一](./47-boss-hallucination.md) |
| **AI 治理 (AI Governance)** | 组织层面对 AI 使用的制度设计：输出标注来源、双人复核、审计日志、可信度分级 | [续集二十一](./47-boss-hallucination.md) |
| **决策传导 (Decision Propagation)** | AI 输出 → 管理者决策 → 组织执行的传导链；传导链越长，AI 幻觉的爆炸半径越大 | [续集二十一](./47-boss-hallucination.md) |
| **可信度分级 (Credibility Tiering)** | 按决策风险等级对 AI 输出做分级管理：高风险（战略/预算/人事）只能参考，中风险需核实，低风险可直接使用 | [续集二十一](./47-boss-hallucination.md) |
| **AI 输出来源标注** | 所有 AI 生成的数据/结论必须附带可验证出处（链接、引用、原始数据）；没有来源 = 不可信 | [续集二十一](./47-boss-hallucination.md) |
| **双人复核机制** | 涉及战略/预算/人事的 AI 辅助决策，必须有第二人独立核实 AI 输出的事实基础 | [续集二十一](./47-boss-hallucination.md) |
| **AI 使用审计日志** | 记录"谁在什么场景用了 AI、AI 输出了什么、基于此做了什么决策"，用于事后追溯 | [续集二十一](./47-boss-hallucination.md) |
| **权威偏误 (Authority Bias)** | 管理者倾向于相信 AI 输出——"AI 看起来客观、专业、有数据，机器不会骗人" | [续集二十一](./47-boss-hallucination.md) |
| **确认偏误 (Confirmation Bias)** | 管理者更相信"符合自己预期"的 AI 输出，忽视反面证据 | [续集二十一](./47-boss-hallucination.md) |
