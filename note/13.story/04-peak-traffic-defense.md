...
- [04.system-design/.../seckill-without-redis](../06.distributed-systems/03-high-availability/rate-limiting/seckill-without-redis.md) — **餐厅流量 = 茅台秒杀**的工程化版本：5 大单机方案对比 + 3 大机制（乐观锁 / version / 唯一约束）+ 2 台服务器一致性 + 实战模板
