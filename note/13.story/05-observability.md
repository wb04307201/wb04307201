...
> 🆕 **5 问完整技术解析**：Prompt vs if-else 4 信号决策 + 5 层路由 + Self-Consistency + 双 timeout + Trace 监控 → 详见 [大模型思维工程专题](../../note/11.ai/08-llmops/production-stability/README.md)（含 7 文件 1512 行）。面试精选 5 题（拆分独立版）见 [思维范式](../../note/12.interview/11.ai/llm-thinking-paradigm/) · [成本控制](../../note/12.interview/11.ai/llm-cost-control/) · [一致性](../../note/12.interview/11.ai/llm-consistency/) · [超时熔断](../../note/12.interview/11.ai/llm-timeout-circuit-breaker/) · [监控](../../note/12.interview/11.ai/llm-monitoring/)。
