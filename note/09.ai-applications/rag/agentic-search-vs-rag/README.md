...
Agentic Search 是 AI Coding 检索范式的演进，**与 [驾驭演进主线（Prompt → Context → Harness → Loop）](../../../09.ai-applications/agent/agent-architecture/llm-control-evolution.md) 同源**：
...
**架构视角**：
- [11.ai 驾驭演进主线](../../../09.ai-applications/agent/agent-architecture/llm-control-evolution.md)
