...
module:
  ...
  slug: ai-applications/rag/vector-search-algorithms
  type: article
  category: AI 应用子文章
...
向量检索算法演进是 驾驭演进主线 在 RAG 领域的具体体现：
