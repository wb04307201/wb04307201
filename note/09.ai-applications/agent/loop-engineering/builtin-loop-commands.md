...
- 面试题：[13.split-hairs Loop Engineering](../../../12.interview/11.ai/loop-engineering/README.md)
- 关联：[大模型思维工程 5 问](../../08-llmops/production-stability/README.md) — 成本 5 层路由（Loop 的成本控制）
