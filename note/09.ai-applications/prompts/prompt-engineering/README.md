...
> 完整陷阱 + 反直觉 + 30 秒话术见 [13.split-hairs Prompt Engineering](../../../../12.interview/11.ai/prompt-engineering/README.md)（⚠️ 待 Phase 1+ 迁入）
...
- 关联：[RAG](.././03-rag-vs-finetuning.md) — Prompt 工程在 RAG 中的应用
