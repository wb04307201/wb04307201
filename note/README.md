...
### 键值存储数据库
#### [缓存](03.database/base/nosql/key-value/cache/README.md)
##### [缓存与数据库一致性](03.database/base/nosql/key-value/cache/consistency-between-cache-and-database/README.md)
##### [缓存稳定性的3种经典问题](03.database/base/nosql/key-value/cache/cache-stability/README.md)
...
### [Redis](03.database/base/nosql/key-value/redis/README.md)

## [关系型数据库和NoSQL数据库的区别](03.database/base/database-vs-nosql/README.md)
...
#### [嵌入与向量化的区别](11.ai/2026/llm/Embedding-vs-vectorization/README.md)
### [多模态：感知-认知统一架构——当AI学会“看懂”并“理解”世界](11.ai/2026/moe/README.md)
...
#### [大模型显存估算指南：Transformer、MoE 与 Mamba 架构深度解析](11.ai/2026/other/memory-estimation/README.md)
#### [prompt模板](11.ai/2026/other/prompt/README.md)
