...
| 5 | [05 安全](04.system-design/05-security/README.md) | Web 攻防、JWT、OAuth2、API 安全、OWASP、加密、密钥管理 |
...
> 以餐厅经营为叙事主线，用 **49 篇** 故事讲透从架构演进到 AI 转型的技术全景。传统工程（前传 / 续集一 / 正传 14 / 终章 / 番外）+ AI 时代续集（含评测 / 协议 / Token 三组 a/b 拆分）—— 一篇一个核心主题，篇篇独立又互相串联。
>
...
| 序号 | 主题 | 核心内容 |
|------|------|----------|
| 1 | [系列导览](12.story/README.md) | 49 篇全景图 + 4 条主路径 + 13 类角色推荐 + 概念交叉索引 |
...
| 10 | [续集 18-20 + 番外九 + 推理（5 篇）](12.story/42-ai-engineer-responsibility.md) | [42 AI 责任](12.story/42-ai-engineer-responsibility.md) / [43 生产力悖论](12.story/43-ai-productivity-paradox.md) / [44 技术债困局](12.story/44-tech-debt-career-trap.md) / [45 Skill 调度](12.story/45-skill-scheduling-restaurant.md) / [46 LLM 推理优化](12.story/46-llm-inference.md) |
| 11 | [辅助资料 · 速查 + 术语](12.story/cheatsheet.md) | [一页纸速查](12.story/cheatsheet.md)（49 篇心法 + AI 选型 + Agent 工具链）；[术语表](12.story/glossary.md)（340+ 词条 / 40 主题）|
...
> 10 大分类共 **224 篇** 深度文章（详见 [QUESTION-FORMAT-SPEC](./13.split-hairs/QUESTION-FORMAT-SPEC.md)，find 校对 2026-07-29），覆盖 Java / 计算机基础 / 数据库 / 系统设计 / 安全 / Spring / 前端 / 大数据 / AI / 工具。
...
| 序号 | 主题 | 文章数 | 入口 |
|------|------|--------|------|
| 1 | Java 基础陷阱 | 42 | [01.java](13.split-hairs/01.java/README.md) |
...
| 4 | 系统设计难点 | 23 | [04.system-design](13.split-hairs/04.system-design/README.md) |
...
| 9 | AI 新概念 | 56 | [11.ai](13.split-hairs/11.ai/README.md) |
...
| [快速加索引](13.split-hairs/03.database/mysql-quickly-add-index/README.md) | 大表在线加索引 |
...
>
> ⚠️ **2026-06-30 新建主模块**：原 `13.split-hairs/04.system-design/project-management/` 中 2 篇已迁回本主模块（`app-quote-breakdown` / `outsourcing-pitfalls`），`mobile-tech-stack` 计划迁至主模块 `09.front-end/08-cross-platform/`。当前主模块共 **6 个专题** + 1 个速查表（`cheatsheet.md`）。
