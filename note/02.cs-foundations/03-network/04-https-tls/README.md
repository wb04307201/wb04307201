...
HTTPS = HTTP + TLS，通过加密防止中间人窃听/篡改。TLS 1.3 相比 1.2 握手更快、更安全，但配置不当仍会出问题。

本篇从对称/非对称加密基础到 TLS 1.3 握手流程，覆盖证书管理、Let's Encrypt 自动化、生产环境常见陷阱。
...
详见 [`kubernetes/08-operator-and-gitops`](../../../07.devops-and-tools/01-tools/kubernetes/08-operator-and-gitops/README.md)
