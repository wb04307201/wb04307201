...
## 相关章节
- 上游：[`计算机基础`](../README.md)
- 关联：[`02-os/linux`](../02-os/linux/) — Linux 命令是运维操作的基础
- 关联：[`03-network`](../03-network/) — 网络指标（延迟/丢包）依赖协议知识
...
| 统计维度 | 数值 | 口径 |
|----------|------|------|
| 分类主题数 | 2 | 服务器性能指标 / 云服务模式 |
| 子 README 数 | 2 | server-metrics / cloud-services 各 1 leaf |
